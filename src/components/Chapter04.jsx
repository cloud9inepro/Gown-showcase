...
export const Chapter04 = () => {
  return (
    <>
      ...
      <directionalLight intensity={6} color="#fff" position={[0, 0, 1]}/>
      ...
      {/* <Bracelet position={[0, 0, 0]} rotation={[0, 0, 0]}/> */}
        <Pillar scale={0.3} position={[0, -0.6, 0.05]} rotation={[1.57, 0, 0]}/>
        <Heels  position={[0, -0.58, 0.35]} rotation={[1.57, 0, 0]}/>
        
          <group>
              <VaseStand scale={0.5} position={[0.7, 0.2, -0.25]} rotation={[1.57, 0, 0]}/>
              <Ring scale={0.5} position={[0.7, 0.2, 0.2]} rotation={[1.57, 0.9, 0]}/>
          </group>
        <group  position={[0, 0.5, 0]}>
           <Necklaces scale={0.5} position={[-0.9, -0.8, 0.01]} rotation={[1.57, 0, 0]}/>
           <AntiqueTable scale={0.012} position={[-0.9, -0.8, -0.25]} rotation={[1.57, 0, 0]}/>
        </group>
